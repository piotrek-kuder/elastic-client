...
@Service
public class ElasticDocumentationDemoService {
    ...
    private static final String HOST = "https://localhost:9200";
    private static final Integer PORT = 9200;
    private static final Logger LOG = LoggerFactory.getLogger(ElasticDocumentationDemoService.class);
